...
| US-23 warm starts | Core/raw-provider implementation verified; cross-story gates remain | Bounded repertoires, twelve-facet keys, freshness/uncertainty/force-fresh, metered storage and reused-learning guard are integrated. [Pinned noisy evidence](../benchmarks/evidence/noisy-reuse/3c0a680/README.md): 1,152 runs, 358,400 distinct acquired samples, equal priors, fresh confirmation and paid replay; 661 tests on each core target. Production raw scalar provider in [AiDotNet #2182](https://github.com/ooples/AiDotNet/pull/2182): 963 integration tests each on net10/net8 and 22 legacy provider cases. CLI wiring, representative cross-system evidence, hosted review and released-package integration remain. No superiority or full-plan completion claim. |
