...
| US-09 Pareto pipeline | Implemented; final verification/review pending in #52 | Feasible fronts, explicit objectives/representatives, snapshots/results/queries, front selection/migration/hypervolume stopping, optional separate infeasible exploration, versioned checkpoints, and a retained 180-run scalar comparison. US-03/US-04 dependency gates remain; no general superiority claim. |
