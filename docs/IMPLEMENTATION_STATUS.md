...
| US-09 Pareto pipeline | Implemented and locally verified; ready for review in #52 | 716 tests pass on each TFM; 55 dedicated cases; 180-run scalar comparison and identical disabled-exploration replay. Feasible fronts, explicit objectives/representatives, snapshots/results/queries, front selection/migration/hypervolume stopping, separate infeasible exploration and versioned checkpoints. Hosted CI and US-03/US-04 merge gates remain; no general superiority claim. |
