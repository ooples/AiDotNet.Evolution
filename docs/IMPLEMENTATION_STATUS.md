...
| US-15 multi-fidelity | Implemented; local acceptance verified, review pending | [Story evidence](evolution-stories/US-15.md): actual epoch-based training, fresh full confirmation, bounded settled-bracket checkpoints, original ledger/tokens and no-duplicate-work process restart. 710 tests per target, 25 analysis tests; 256-run pinned pilot plus exact replay. Not arbitrary in-flight recovery, full Hyperband or representative superiority; US-12/US-21 and companion integrations remain separate. |
