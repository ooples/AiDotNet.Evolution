...
| US-09: Preserve useful tradeoffs between objectives | [#27](https://github.com/ooples/AiDotNet.Evolution/issues/27) | [Current-stack functionality and 288-run evidence locally verified](evolution-stories/US-09.md); CI/review/merges pending | Integration on #86, incorporating historical [#52](https://github.com/ooples/AiDotNet.Evolution/pull/52); publication pending |
