...
US-08 / #51, US-09 / #52, US-10 / #53 and US-13 / #55 are ready for review; US-16 / #58 now has complete fixed-pool local acceptance evidence.
...
US-08, US-09, US-10, US-13 and US-16 have tested story-owned changes. US-14 implementation/audit is in progress.
...
| US-16: Adapt islands and restart stalled searches | [#34](https://github.com/ooples/AiDotNet.Evolution/issues/34) | Fixed-pool acceptance verified; review/dependencies open | [AiDotNet.Evolution#58](https://github.com/ooples/AiDotNet.Evolution/pull/58) |
...
## US-16 fixed-pool delivery

[US-16 / #58](https://github.com/ooples/AiDotNet.Evolution/pull/58) implements adaptive island proposal allocation, guaranteed exploration floors, bounded elite-preserving restart phases and strict policy/child checkpointing. At `a6199ee`, all 745 tests pass on each framework; 240 primary pilot runs pass replay/accounting and eight aligned checkpoint checks. Full evidence and limitations are in [US-16](evolution-stories/US-16.md). The authored pilot supports restart escape, not adaptive-allocation superiority; no default was promoted. Current-head CI, review and dependency integration remain open.
...
The fix remains on #51, not the shared foundation. It is integrated into US-13 / #55 and US-16 / #58; the active US-14 worktree has also integrated it. US-23 still requires integration.
