...
and US-26 / #63 adds an implemented bounded offline policy optimizer with held-out validation.
...
All initial story PR commits were **tracking-only checklists**. US-08, US-09, US-10 and US-26 subsequently added tested implementation;
