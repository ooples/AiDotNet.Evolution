...
| US-14: Rank proposals using a surrogate model | [#32](https://github.com/ooples/AiDotNet.Evolution/issues/32) | [Functional acceptance integrated and locally verified](evolution-stories/US-14.md); default off, CI/review pending | Incorporates [AiDotNet.Evolution#56](https://github.com/ooples/AiDotNet.Evolution/pull/56) |
