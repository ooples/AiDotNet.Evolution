// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:tests/AiDotNet.Tests/UnitTests/Evolution/Programs/LlmJudgeCritiqueTests.cs
...
public sealed class LlmJudgeCritiqueTests
{
    ...
    public async Task TheJudgesReasoningIsAttachedAsAnArtifact()
    {
        ...
        Assert.False(artifact.IsRedacted);
    }
    ...
    public async Task TheMeasuredEvaluatorsOwnMetricsAndArtifactsSurviveTheJudge()
    {
        ...
        EvolutionTaskResult result = await new LlmJudgeProgramFitnessEvaluator(
    ...
    private static LlmJudgeProgramFitnessEvaluator Judge(
