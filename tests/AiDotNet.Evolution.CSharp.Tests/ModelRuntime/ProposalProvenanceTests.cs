// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:tests/AiDotNet.Tests/UnitTests/Evolution/Programs/ProposalProvenanceTests.cs
...
public sealed class ProposalProvenanceTests : IDisposable
{
    ...
    public async Task TheOperatorRecordsEveryRequestIncludingTheOnesThatFailed()
    {
        ...
        {
            Usage = new ProgramChatUsage(120, 45)
        };
