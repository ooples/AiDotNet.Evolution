// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:tests/AiDotNet.Tests/UnitTests/Evolution/Programs/ProgramPromptBuilderTests.cs
...
public sealed class ProgramPromptBuilderTests
{
    ...
    {
        var free = new ProgramPromptBuilder(new ProgramEvolutionPromptOptions(), new ProgramProposalOptions());
        ...
        var enforced = new ProgramPromptBuilder(
            ...
            new ProgramProposalOptions { EnforceEvolveBlocks = true, Language = ProgramLanguage.Python });
    ...
    public void MessagesAreASystemMessageFollowedByTheUserMessage()
    {
        ...
        Assert.Equal(ProgramChatRole.System, result.Messages[0].Role);
        Assert.Equal(ProgramChatRole.User, result.Messages[1].Role);
