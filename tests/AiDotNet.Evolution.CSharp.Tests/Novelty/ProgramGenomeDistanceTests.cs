// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:tests/AiDotNet.Tests/UnitTests/Evolution/Programs/Novelty/ProgramGenomeDistanceTests.cs
...
public sealed class ProgramGenomeDistanceTests
{
    ...
    public void LineEditDistanceBoundsHowMuchOfAProgramItCompares()
    {
        ...
        Assert.True(bounded.Distance(first, second) > 0.0);
    ...
    public void BothStructuralMetricsExposeStableIdentitiesAndRejectNulls()
    {
        ...
        Assert.Equal("program-token-set-v2", tokens.VersionHash);
