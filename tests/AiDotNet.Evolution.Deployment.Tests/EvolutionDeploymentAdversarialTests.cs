...
public sealed partial class EvolutionDeploymentLifecycleTests
{
    ...
    public void StoredValidation_InvalidRawMeasurementIsAStorageError()
    {
        ...
        {
            CandidateId = Program("winner").Id,
            IncumbentId = Program("base").Id,
    ...
    public void ModelArtifact_DoesNotSuppressPersistenceLicenseDenial()
    {
        ...
        var error = Assert.Throws<AiDotNetConsumer::AiDotNet.Exceptions.LicenseRequiredException>(() =>
    ...
    {
        internal readonly AiDotNetConsumer::AiDotNet.Exceptions.LicenseRequiredException Denial = new("fixture entitlement denial");
