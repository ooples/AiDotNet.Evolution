...
public sealed class StoryPullRequestWorkflowTests
{
    ...
    public void Story_prs_run_existing_gates_without_expanding_push_triggers(string filename)
    {
        ...
        Assert.Equal(new[] { "main", "feat/competitive-evolution-platform", "feat/evolution-us-*", "feat/evolution-us02-efficacy", "feat/evolution-us05-campaign-budget" }, Branches(pullRequest));
