...
public sealed class StoryPullRequestWorkflowTests
{
    ...
    public void Story_prs_run_existing_gates_without_expanding_push_triggers(string filename)
    {
        ...
        Assert.Equal(new[] { "main", "feat/competitive-evolution-platform", "feat/evolution-us-*", "feat/evolution-us02-efficacy", "feat/evolution-us03-correctness", "feat/evolution-us05-campaign-budget", "feat/evolution-us06-noise-integration", "feat/evolution-us07-ablation-integration", "feat/evolution-us08-portfolio-integration", "chore/evolution-pr-consolidation" }, Branches(pullRequest));
