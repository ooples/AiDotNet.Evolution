// Relocated from ooples/AiDotNet d4535f7376888a7c2d35d7e6229494c4c60c0ac6:src/Evolution/Deployment/DeploymentValidationEvidence.cs
...
internal sealed class DeploymentRawMeasurement
{
    ...
    {
        CorrectnessPassed = measurement.CorrectnessPassed,
        IsFresh = measurement.IsFresh,
        HasQuality = measurement.HasQuality,
        Quality = measurement.Quality,
        ElapsedTicks = measurement.Elapsed.Ticks,
        CostUnits = measurement.CostUnits
    };
