// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:src/Evolution/Programs/Provenance/ProposalProvenanceReader.cs
...
public static class ProposalProvenanceReader
{
    ...
    {
        ProgramGuard.NotNullOrWhiteSpace(path);
        if (maxTotalBytes <= 0L)
        {
    ...
    public static ProposalProvenanceLineage BuildLineage(
        ...
        IReadOnlyList<ProposalProvenanceRecord> records)
    {
        ProgramGuard.NotNullOrWhiteSpace(genomeId);
        ProgramGuard.NotNull(records);
