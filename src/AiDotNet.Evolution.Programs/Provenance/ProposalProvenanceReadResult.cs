// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:src/Evolution/Programs/Provenance/ProposalProvenanceReadResult.cs
...
public sealed class ProposalProvenanceReadResult
{
        ...
        long bytesRead)
    {
        ...
        ProgramGuard.NotNull(files);
        ProgramGuard.NonNegative(malformedLineCount);
        if (bytesRead < 0L)
        {
