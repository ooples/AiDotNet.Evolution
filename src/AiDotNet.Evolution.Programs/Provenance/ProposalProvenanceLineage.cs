// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:src/Evolution/Programs/Provenance/ProposalProvenanceLineage.cs
...
public sealed class ProposalProvenanceLineage
{
    ...
    {
        ProgramGuard.NotNullOrWhiteSpace(finalGenomeId);
        ProgramGuard.NotNull(steps);
