// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:src/Evolution/Programs/Provenance/ProposalProvenanceLineageStep.cs
...
public sealed class ProposalProvenanceLineageStep
{
    ...
    public ProposalProvenanceLineageStep(int stepIndex, ProposalProvenanceRecord record)
    {
        ...
        ProgramGuard.NonNegative(stepIndex);
        StepIndex = stepIndex;
        Record = record;
    }
