// Source: ooples/AiDotNet 66d7602c92101e5ab2bd9db8cfa7f7526fa2c75d:src/Evolution/Programs/PersistentProgramFitnessEvaluator.cs; original BSL license retained in src/AiDotNet.Evolution.Programs/AIDOTNET-LICENSE.txt.
...
/// <remarks>
/// Supply this decorator as the fitness evaluator to ProgramEvolution.CreateEngine and disable the engine's
/// EnableEvaluationCache. The entry point runs correctness before every fitness lookup. The scope identifies
...
/// </remarks>
public sealed class PersistentProgramFitnessEvaluator : IProgramFitnessEvaluator, IProgramResourceLedgerProvider
{
    ...
    /// <summary>Gets the live ledger used for persistence and evidence operations.</summary>
    public EvolutionResourceLedger Ledger => _ledger;
    /// <inheritdoc/>
