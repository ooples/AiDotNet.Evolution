// Migrated from ooples/AiDotNet 66d7602c92101e5ab2bd9db8cfa7f7526fa2c75d:src/Evolution/Programs/CorrectnessGatedProgramFitnessEvaluator.cs
...
internal sealed class CorrectnessGatedProgramFitnessEvaluator : IProgramFitnessEvaluator
{
    ...
    {
        ProgramGuard.NotNull(correctness);
        ProgramGuard.NotNull(fitness);
        ProgramGuard.NotNullOrWhiteSpace(correctness.Id);
        ProgramGuard.NotNullOrWhiteSpace(correctness.VersionHash);
        ProgramGuard.NotNullOrWhiteSpace(fitness.Id);
        ProgramGuard.NotNullOrWhiteSpace(fitness.VersionHash);
