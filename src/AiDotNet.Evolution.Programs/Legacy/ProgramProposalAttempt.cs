// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:src/Evolution/Programs/ProgramProposalAttempt.cs
...
public sealed class ProgramProposalAttempt
{
    ...
    public ProgramProposalAttempt(
        ...
        int outputTokens = 0)
    {
        ProgramGuard.NotNullOrWhiteSpace(parentGenomeId);
        VersionPinnedProgramFitnessEvaluator.ValidateIdentity(parentGenomeId, nameof(parentGenomeId));
        ProgramGuard.Positive(attemptNumber);
