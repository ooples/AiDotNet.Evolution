// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:src/Evolution/Programs/ProgramDiffBlock.cs
...
/// line endings normalized to line feeds by the response parser, with content whitespace preserved.
/// Direct construction retains both strings exactly. <see cref="Ordinal"/> and <see cref="ResponseLine"/>
...
public sealed class ProgramDiffBlock
{
    ...
    {
        ProgramGuard.NotNull(searchText);
        ProgramGuard.NotNull(replaceText);
        ProgramGuard.NonNegative(ordinal);
        ProgramGuard.NonNegative(responseLine);
