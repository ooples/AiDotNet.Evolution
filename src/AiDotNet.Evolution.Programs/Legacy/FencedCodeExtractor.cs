// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:src/Evolution/Programs/FencedCodeExtractor.cs
...
public static class FencedCodeExtractor
{
    ...
    /// <summary>Extracts only complete fences, retaining content whitespace and mixed terminators.</summary>
    /// <remarks>The terminator separating source from the closing fence is transport, not source.
    /// Callers must check SelectionSource and validate language and correctness before executing the result.</remarks>
    public static FencedCodeExtractionResult ExtractExact(string response, ProgramLanguage language)
