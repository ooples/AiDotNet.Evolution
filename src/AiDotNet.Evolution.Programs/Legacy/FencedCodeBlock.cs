// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:src/Evolution/Programs/FencedCodeBlock.cs
...
public sealed class FencedCodeBlock
{
    ...
    {
        ProgramGuard.NotNull(label);
        ProgramGuard.NotNull(content);
        ProgramGuard.NonNegative(startLine);
