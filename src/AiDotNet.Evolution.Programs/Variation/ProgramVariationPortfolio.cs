// Migrated from ooples/AiDotNet 66d7602c92101e5ab2bd9db8cfa7f7526fa2c75d:src/Evolution/Programs/ProgramVariationPortfolio.cs
// Original license retained in AIDOTNET-LICENSE.txt.
namespace AiDotNet.Evolution.Programs;

/// <summary>An opt-in, cost-validated adaptive program portfolio usable through ProgramEvolution.CreateEngine.</summary>
/// <remarks>Every child must provide checkpointed proposal costs in the policy's units. Supply metered mutation,
/// crossover, restart, local-refinement or consumer LLM backends without changing the engine. Child usage is summed
/// once; missing provider usage is not a zero-cost claim. This does not relax the coordinated-ledger-resume
