// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:src/Configuration/ProgramDiffOptions.cs
...
public sealed class ProgramDiffOptions
{
    ...
    /// <summary>Maximum response characters inspected before parsing, capped at four MiB.</summary>
    public int MaxResponseChars { get; set; } = 4 * ProgramGenome.MaxSourceLength;
    ...
    public void Validate()
    {
        ...
        if (MaxResponseChars <= 0 || MaxResponseChars > 4 * ProgramGenome.MaxSourceLength)
