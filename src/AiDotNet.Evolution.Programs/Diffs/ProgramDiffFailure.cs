// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:src/Evolution/Programs/ProgramDiffFailure.cs
...
public sealed class ProgramDiffFailure
{
    ...
    public ProgramDiffFailure(ProgramDiffFailureReason reason, string message, int blockOrdinal = -1, string searchExcerpt = "")
    {
        ...
        ProgramGuard.NotNullOrWhiteSpace(message);
        ProgramGuard.NotNull(searchExcerpt);
