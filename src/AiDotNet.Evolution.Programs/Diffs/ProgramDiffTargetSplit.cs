// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:src/Evolution/Programs/ProgramDiffTargetSplit.cs
...
public sealed class ProgramDiffTargetSplit
{
    ...
    {
        ProgramGuard.NotNull(programBlocks);
        ProgramGuard.NotNull(descriptionBlocks);
        ProgramGuard.NotNull(failures);
