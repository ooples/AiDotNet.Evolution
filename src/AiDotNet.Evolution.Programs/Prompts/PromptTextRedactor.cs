// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:src/Evolution/Prompts/PromptTextRedactor.cs
...
public static class PromptTextRedactor
{
    ...
    {
        ProgramGuard.NotNull(text);
        ProgramGuard.NotNull(truncationMarker);
        if (maxBytes < 0)
        {
