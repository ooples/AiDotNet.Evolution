// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:src/Evolution/Prompts/ProgramPromptTemplateSet.cs
...
public sealed class ProgramPromptTemplateSet
{
    ...
    {
        ProgramGuard.NotNullOrWhiteSpace(directory);
        ProgramGuard.NotNull(baseSet);
