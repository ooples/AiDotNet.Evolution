// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:src/ProgramSynthesis/Interfaces/IProgramExecutionEngine.cs
...
{
    /// <summary>Stable identity of the caller-provisioned execution boundary.</summary>
    string Id { get; }

    /// <summary>Version of its execution semantics; change when configuration or provisioned runtime changes.</summary>
