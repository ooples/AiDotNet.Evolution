// Migrated from ooples/AiDotNet 9cd7d5d6c366a483874024650d02901f69a1829c:src/Configuration/ProgramInterpreterSpecification.cs
...
/// <see cref="AiDotNet.Evolution.Programs.ProgramExecuteRequest.CompileOnly"/> against a language with no
...
public sealed class ProgramInterpreterSpecification
{
        ...
        bool quoteWithDoubleQuotes)
    {
        ...
        // Replace tokens in the original template only: a path may itself contain a placeholder.
        return System.Text.RegularExpressions.Regex.Replace(template, @"\{source\}|\{workspace\}",
            match => match.Value == SourcePlaceholder ? source : workspace);
    }
