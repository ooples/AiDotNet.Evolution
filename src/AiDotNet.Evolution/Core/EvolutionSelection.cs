...
/// <remarks>
/// <para>
/// An <see cref="AiDotNet.Evolution.ISelectionPolicy{TGenome}"/> returns one instance per proposal. The engine
...
/// <see cref="EvolutionEngineOptions.InspirationCount"/>, but the list can be shorter, even
