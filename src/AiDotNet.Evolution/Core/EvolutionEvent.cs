...
/// <remarks>
/// <para>
/// The engine reports progress to an <see cref="AiDotNet.Evolution.IEvolutionObserver{TGenome}"/> as a stream of
...
/// 2,4". Write a small class that implements <see cref="AiDotNet.Evolution.IEvolutionObserver{TGenome}"/>, hand it
